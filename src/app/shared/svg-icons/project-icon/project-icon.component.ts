...
@Component({
  ...
  template: `<svg class="shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <title id="brifcaseIconTitle">{{Messages.Headers.myProjects}}</title>
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="work-case" fill="#374151" transform="translate(42.666667, 64.000000)">
                                    <path
