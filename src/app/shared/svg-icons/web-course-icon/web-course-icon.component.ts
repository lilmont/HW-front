...
@Component({
  selector: 'hw-web-course-icon',
  template: `<svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"
                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <title id="webIconTitle">{{Messages.Headers.webCourse}}</title>
                            <g id="style=fill">
                                <g id="web">
                                    <g id="Vector">
                                        <path
...
export class WebCourseIconComponent {
  Messages = Messages;
}
