export const Messages = {
    ...
    Titles: {
        ...
        academy: 'آکادمی هاردورکر',
        academySubtitle: 'فیلم معرفی کارآموزی'
    },
    TableHeaders: {
        id: 'ID',
        firstName: 'نام',
        ...
        courseReferralPercentage: 'درصد معرفی دوره ها',
        hostingPlanReferralPercentage: 'درصد معرفی هاست ها',
        contact: 'مخاطب',
    ...
    اگر از طریق این لینک ثبت‌ نام کنند، با هر خرید آن‌ها از دوره‌ها، `,
        ...
        academyText1: 'متاسفانه اکثر فارق التحصیل ها بعد از اتمام تحصیلاتشون متوجه میشن که تخصص و مهارت لازم برای ورود به بازار کار رو ندارن.',
        academyText2: 'تا فرصت هست اجازه نده چنین اتفاقی برات بیفته.'
    }
};
